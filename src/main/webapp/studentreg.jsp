...
<ul>
<li><a href="index.jsp" style="color:rgb(0,204,136);">首页</a></li>

<li><div id="d1"><a href="studentlogin.jsp" style="margin-left:30px;">登录</a></div></li>
</ul>
<p id="p1">大学生</p>
...
<div class="el-form-item">
	<div class="el-form-item__content">
		<div class="el-input" style="margin-top:-40px;">
			<input autocomplete="off" placeholder="手机号" type="text" id="Stu_telephone" name="Stu_telephone" rows="2" maxlength="11" validateevent="true" class="el-input__inner">
