...
<div id="d2" style="height: 400.5px; display: block;">
	<img src="img/pcicon1.png" class="i1" style="width: 55px; height: 55px;" />

	<form class="el-form" id="el-form">
		<input autocomplete="off" placeholder="手机号" type="text"  id="Stu_name" name="Stu_name" rows="2" maxlength="11" validateevent="true" class="el-input__inner">
