		...
		<form class="layui-form layui-form-pane" id="User_login_action" name="User_login_action">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="admin_username" id="User_login_action_username" required="true" type="text" name="account" class="layui-input" lay-verify="account"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="admin_password" id="User_login_action_password" required="true" type="password" name="password" class="layui-input"
