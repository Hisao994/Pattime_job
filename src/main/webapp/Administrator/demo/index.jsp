            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="side-main">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;" href-url="service/adviceList.jsp"><i class="layui-icon">&#xe621;</i>客服投诉</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="javascript:;" href-url="search/studentList.jsp"><i class="layui-icon">&#xe621;</i>学生总览</a></dd>
                    </dl>
                </li>
            </ul>
        </div>
