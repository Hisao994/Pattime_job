...
public class Student_baseinfo implements Serializable {
	...
	public String getStu_stuidcard() {
		return stu_stuidcard;
	}
	public void setStu_stuidcard(String stu_stuidcard) {
		this.stu_stuidcard = stu_stuidcard;
	}
	...
	public String toString() {
		return "Student_baseinfo [stu_id=" + stu_id + ", stu_name=" + stu_name
				...
				+ ", stu_school=" + stu_school + ", stu_stuidcard="
				+ stu_stuidcard + "]";
	}
